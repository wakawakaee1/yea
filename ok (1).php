        ...
        * {
        ...
        body {
            ...
            background: linear-gradient(rgba(0,0,0,0.1), rgba(0,0,0,0.2)), 
                        url('https://i.ibb.co/v6ySpGbp/f3e5fc10ba836a979852f3d8718acf38.jpg') no-repeat center center fixed;
...
<body>
    <div class="container">
        <!-- HEADER -->
        <div class="header">
            <h1 style="font-size: 18px; margin-bottom: 5px;">GAS🏴‍☠️</h1> <span style="color:gold;">BANG JAGO</span></h3>
